from compiled_stage import compiled_stage
...
def advance_compiled(self,dt_ns,current_pA,*,rtol=1e-9,atol=2e-12,maxiter=220,
    ...
    def stage(vbase,xbase,guess,synapse,ca_base,ca_update,threshold_guess=None):
        return compiled_stage(self,vbase,xbase,guess,synapse,ca_base,ca_update,threshold_guess,

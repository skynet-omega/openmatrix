"""Bounded organism test of explicit physical SET/ADD event representation."""
...
def main() -> int:
    ...
    p.add_argument('--ms', type=int, choices=(1,130,400), required=True)
    ...
    max_wall = 240 if a.ms == 1 else (700 if a.ms == 130 else 2050)
    ...
    try:
        ...
        import event_waveform,event_ports,event_coupling
        ...
        atomic_json(a.out/'RUN_CONTRACT.json',{
            ...
            'event_representation':'physical SET(post_q) plus genuine ADD(jump); no state clipping',

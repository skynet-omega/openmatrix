...
def main():
    off,on=read('smoke_sham_off_01'),read('smoke_sham_on_01')
    a,za=off;b,zb=on
    results={}
    for field in FIELDS:
        differences=[]
    ...
    same_files={name:sha(HERE/'smoke_sham_off_01/final_state'/name)==sha(HERE/'smoke_sham_on_01/final_state'/name)

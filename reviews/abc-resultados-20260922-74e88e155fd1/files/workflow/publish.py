...
import argparse,hashlib,json,re,zipfile,subprocess,tempfile,shutil,urllib.request
...
ALLOWED=[ROOT/'motor_nuevo',ROOT/'instrumentos/openmatrix',Path('/home/daroch/AXIOMA_FLYWIRE/matrix/work/motor14_20260922'),Path('/home/daroch/AXIOMA_FLYWIRE/matrix/runs/motor14_20260922')]
EXT={'.py','.cu','.cpp','.md','.json','.jsonl','.npz','.log','.txt'}
TEXT=EXT-{'.npz'}

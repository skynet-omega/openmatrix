...
def rebuild_pn_stage_graph(obj):
    """Diagnostic only: discard one execution cache, retain all committed state."""
    import cupy as cp
    ...
    return {'cache': 'PN StageGraph', 'cache_owner': 'pn_execution.install.view',
...
def prepare(out, reference_continuous=None, rebuild_stage_graph=False,
    ...
    try:
        ...
        if rebuild_stage_graph:
            result['cache_discriminator'] = rebuild_pn_stage_graph(obj)

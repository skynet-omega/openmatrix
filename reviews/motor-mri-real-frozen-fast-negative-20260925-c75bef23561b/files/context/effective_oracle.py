...
class EffectiveOracle:
    def __init__(self, adapter):
        ...
        # A captured graph also uses short-lived model temporaries. Retain
        # their allocator for the graph lifetime; a candidate's allocations
        # must not reuse those addresses after graph construction.

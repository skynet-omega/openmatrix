...
r=json.loads((R/'ADDENDUM_PUBLICATION.json').read_text());local=json.loads((R/'ADDENDUM_DELIVERY.json').read_text());base=r['raw_index'].rsplit('/',1)[0]+'/'
...
(R/'ADDENDUM_REMOTE_CHECK.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result))

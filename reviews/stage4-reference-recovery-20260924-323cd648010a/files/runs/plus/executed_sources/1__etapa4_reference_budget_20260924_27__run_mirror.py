...
def main() -> int:
    ...
    a = p.parse_args()
    if a.engine != 'reference_cuda':
        raise ValueError('Recovery27 permits only strict reference_cuda runs')
    prep = 40
    trial_ms = 400
    max_wall = json.loads((HERE/'PLAN.json').read_text())['budget']['wall_each_s_max']

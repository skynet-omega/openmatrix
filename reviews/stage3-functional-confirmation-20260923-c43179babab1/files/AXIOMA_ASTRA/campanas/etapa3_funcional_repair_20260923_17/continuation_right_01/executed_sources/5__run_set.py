...
def main() -> int:
    ...
    p.add_argument('--ms', type=int, choices=(1,20,130,400), required=True)
    ...
    prep = 0 if a.ms in (1,20) else 40
    max_wall = 240 if a.ms == 1 else (600 if a.ms == 20 else (700 if a.ms == 130 else 2050))
    ...
    try:
        ...
        atomic_json(a.out/'RUN_CONTRACT.json',{
            ...
            'biological_parameters_changed':False,'interface_intervention':'PN629 disabled before preparation','stage3_admission':False,

...
def main():
    ...
    p.add_argument('--ms',type=int,choices=(100,),required=True)
    ...
    result['sources']={p.name:hashlib.sha256(p.read_bytes()).hexdigest() for p in
         [HERE/'run_real.py',HERE/'real_model.py',HERE/'graph_runtime.py',HERE/'event_projection.py',HERE/'resident_controller.cu',HERE/'libresident_controller.so',HERE/'PLAN.md']}

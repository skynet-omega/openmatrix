...
def main():
    ...
    lines=[
      ...
      f'- Campos de traza exactos: {exact}/35. Máxima diferencia frente al motor estable: CNS a1s: {neural["cns"]["max_abs"]:.6g}; voltaje celular: {neural["cell_delta"]["max_abs"]:.6g}mV.',

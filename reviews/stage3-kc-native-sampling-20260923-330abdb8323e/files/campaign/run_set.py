...
def main() -> int:
    ...
    p.add_argument('--native-trace', choices=('on','off'), required=True)
    ...
    try:
        ...
        import kc_trace
        kc_trace.ENABLED = a.native_trace == 'on'
        ...
        frozen.mkdir()
        files = [HERE/'kc_trace.py',HERE/'kc_trace.cuh',HERE/'block_midpoint.py',HERE/'PLAN.json',HERE/'run_set.py',HERE/'native_tap.py',
        ...
        atomic_json(a.out/'RUN_CONTRACT.json',{
            ...
            'observer':a.observe,'native_trace':a.native_trace,'preparation_ms':prep,'trial_ms':a.ms,

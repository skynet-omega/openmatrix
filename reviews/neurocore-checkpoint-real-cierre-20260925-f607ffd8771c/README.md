# neurocore-checkpoint-real-cierre-20260925
...
Snapshot inmutable: `neurocore-checkpoint-real-cierre-20260925-f607ffd8771c`. [Manifiesto](MANIFEST.json), [ZIP dividido y hashes](ARCHIVE.json).
...
- [check_after_install.py](files/check_after_install.py)
- [check_checkpoint_guards.py](files/check_checkpoint_guards.py)
- [after_install_01/RESULT.json](files/after_install_01/RESULT.json)
- [run_11_pn_backend_cache/PREPARE.json](files/run_11_pn_backend_cache/PREPARE.json)
- [related/PLAN_ABC.md](files/related/PLAN_ABC.md)
- [after_install_02/RESULT.json](files/after_install_02/RESULT.json)
- [BYTEWISE_FILE_COMPARISON.json](files/BYTEWISE_FILE_COMPARISON.json)
